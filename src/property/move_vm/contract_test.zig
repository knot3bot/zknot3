...
fn addContractBytecode() []const u8 {
    return &.{
        0x30, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x07, // ld_const 7 (with 8-byte payload)
        0x30, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, // ld_const 3
        0x40, // add
        0x01, // ret
    };
}
...
test "Move VM: Knot3 token balance simulation" {
    ...
    const bytecode = &.{
        ...
        0x30, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x2C, // 300
        0x40, // add = 800
        0x01, // ret
    };
